...
<html>
    ...
    <head>
        <title>Mojo-Hand-Chicago-Blues-Rockabilly-Rock-n-roll-Concerts-Franche-Comté-Suisse-Alsace</title>
        <meta name="description" content="Mojo Hand, c'est des concerts blues dans toute la Franche Comte, mais aussi en Alsace ou en Suisse..." />
        <meta name="keywords" content="musique-blues-rockabilly-swing-boogie-shuffle-scene-france-bleu-fimu- 2014-fimu-2014-harmonica-guitare-concerts-belfort-franche-comte-alsace-suisse-festival-sortir" />
    ...
    <body>
        ...
        <section class="centre principale trans">
            <div class="suivre">
                <a href="https://www.facebook.com/mojohandbelfort" target="_blank"><img alt="Facebook" src="imagesmojo/facebook.png" width="50"></a>
                <a href="http://www.reverbnation.com/mojohand7" target="_blank"><img alt="Reverbnation" src="imagesmojo/reverbation.png" width="50"></a>
                <a href="http://www.mupiz.com/mojo-hand1" target="_blank"><img id="mupiz" alt="Mupiz" src="imagesmojo/mupiz.jpg" width="50"></a>
        ...
        <footer class="trans degradebas">
            ...
            <nav class="relative centre">
                <div class="sousnav">
                    <a href="concert-musique-belfort-franche-comte-suisse-alsace-blues-rock-swing-guitare-harmonica.php">Dates</a>
                    ...
                    <a id="l4" href="photos-groupe-musique-belfort-franche-comte-suisse-fimu-festival-concert-montbeliard.php">Pictures</a>
                    
                </div>
                <div class="social">
                   
                    <a id="retoursuivre" href="index.php">Accueil</a>
                </div>
                <a id="retour">
